...
@click.option('--seg_gamma',    help='R1 regularization seg weight', metavar='FLOAT',                     type=click.FloatRange(min=0), required=True)
...
def main(**kwargs):
    ...
    # if c.D_kwargs.class_name == 'training.networks_stylegan2.MaskDualDiscriminator':
    c.D_kwargs.seg_resolution = c.training_set_kwargs.resolution # opts.seg_resolution
    ...
    elif c.training_set_kwargs.resolution == (512,256):
        sr_module = 'training.superresolution.SuperresolutionHybrid8XDCB'
    else:
