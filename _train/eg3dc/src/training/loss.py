...
from training.losses.loss_orthocondA import StyleGAN2LossOrthoCondA # front作为输入
from training.losses.loss_orthocondB import StyleGAN2LossOrthoCondB # back作为输入
