...
class DatasetWrapper(DatasetEG3D):
    ...
    def __getitem__(self, idx):
        ...
        masko = x['image_ortho_front_mask'].numpy()
        ...
        maskl = x['image_ortho_left_mask'].numpy()
        ...
        maskr = x['image_ortho_right_mask'].numpy()
        ...
        maskb = x['image_ortho_back_mask'].numpy()
    ...
    def __getitem__(self, idx, collate=None, det=True, return_more=False):
        if type(idx) in (list, slice, range):
            ...
            for view in ['front', 'left', 'right', 'back']:
                ...
                camo = dklustr.camera_params_to_matrix('eg3d_lustrousB', **xo['render_params']) # distance = 2.0
