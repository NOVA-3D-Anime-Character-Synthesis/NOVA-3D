...
inferquery = 'FRONT_ecrutileE_eclustrousC_n120-00000-000200'
...
seed = 0
for front_bn in tqdm(front_bns):
    # preprocess
    front_x = dk[front_bn]
    with torch.no_grad():
        front_x['resnet_features'] = resnet(front_x.image)
    ...
    with torch.no_grad():
        xin = {
            'cond': {
                ...
                'resnet_chonk': front_x['resnet_features'][None,0],
            },
            'seeds': [seed,],
            **inference_opts,
        }
