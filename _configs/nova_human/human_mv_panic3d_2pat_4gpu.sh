...
cd $PROJECT_DN \
&& CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m _train.eg3dc.trainers.train_multi_view_panic3d_mask_encoder \
    \
    --name=human_mv_panic3d_2Pat \
    ...
    --generator_backbone=training.generator.Generator_v1 \
    ...
    \
    --neural_rendering_resolution_initial=96 \
    --neural_rendering_resolution_final=96 \
