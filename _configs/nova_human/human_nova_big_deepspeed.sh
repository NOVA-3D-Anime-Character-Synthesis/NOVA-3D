...
# && CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m _train.eg3dc.trainers.train_eclustrousC \ ./_train/eg3dc/trainers/train_NOVA_deepspeed.py
cd $PROJECT_DN \
&& export CUDA_VISIBLE_DEVICES=0,1,2,3 
deepspeed --include localhost:0,1,2,3 --master_port 29500  ./_train/eg3dc/trainers/train_NOVA_deepspeed.py\
    --name=human_mv_panic3d_mask_encoder_attention_big \
    --training_loop_version=training_loop_ds \
    ...
    --deepspeed_config=./_configs/ds_config.json \
